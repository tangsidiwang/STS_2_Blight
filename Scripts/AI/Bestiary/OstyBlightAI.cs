...
internal static class OstyBlightHpNumbers
{
...
[HarmonyPatch(typeof(Osty), "get_MinInitialHp")]
public static class OstyMinHpPatch
{
    public static void Postfix(ref int __result)
    {
        ...
        __result += OstyBlightHpNumbers.GetHpAdd();
    }
}

[HarmonyPatch(typeof(Osty), "get_MaxInitialHp")]
public static class OstyMaxHpPatch
{
    public static void Postfix(ref int __result)
    {
        if (!BlightModeManager.IsBlightModeActive)

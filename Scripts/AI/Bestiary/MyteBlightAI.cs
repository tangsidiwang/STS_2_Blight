...
internal static class MyteBlightHpNumbers
{
...
[HarmonyPatch(typeof(Myte), "get_MinInitialHp")]
public static class MyteMinHpPatch
{
    public static void Postfix(ref int __result)
    {
        ...
        __result += MyteBlightHpNumbers.GetHpAdd();
    }
}

[HarmonyPatch(typeof(Myte), "get_MaxInitialHp")]
public static class MyteMaxHpPatch
{
    public static void Postfix(ref int __result)
    {
        if (!BlightModeManager.IsBlightModeActive)

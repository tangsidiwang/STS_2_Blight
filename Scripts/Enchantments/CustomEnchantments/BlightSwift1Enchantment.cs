...
{
    public sealed class BlightSwift1Enchantment : EnchantmentModel, IBlightEnchantment
    {
        ...
        public bool CanApplyTo(CardModel card)
        {
            ...
            if (BlightEnchantmentRuntimeHelper.HasEnchantment<BlightSwift1Enchantment>(card))
            {
                return false;
            }

...
{
    public sealed class BlightFrailSelf1Enchantment : EnchantmentModel, IBlightEnchantment
    {
        private const decimal FrailAmount = 1m;
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await PowerCmd.Apply<FrailPower>(Card.Owner.Creature, FrailAmount, Card.Owner.Creature, null);
        }

...
{
    public sealed class BlightDoom10Enchantment : EnchantmentModel, IBlightEnchantment
    {
        private const decimal DoomAmount = 10m;

        public override bool ShowAmount => true;

        public override int DisplayAmount => 10;
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await PowerCmd.Apply<DoomPower>(Card.Owner.Creature, DoomAmount, Card.Owner.Creature, null);
        }

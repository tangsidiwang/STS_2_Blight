...
{
    public sealed class BlightBrokenBlade1Enchantment : EnchantmentModel, IBlightEnchantment
    {
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await PowerCmd.Apply<WeakPower>(cardPlay.Target, WeakAmount, Card.Owner.Creature, null);
        }

...
{
    public sealed class BlightRavage1Enchantment : EnchantmentModel, IBlightEnchantment
    {
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await PowerCmd.Apply<FrailPower>(cardPlay.Target, FrailAmount, Card.Owner.Creature, null);
        }

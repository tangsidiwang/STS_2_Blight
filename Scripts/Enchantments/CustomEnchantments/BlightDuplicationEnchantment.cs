...
{
    public sealed class BlightDuplicationEnchantment : EnchantmentModel, IBlightEnchantment
    {
        private const decimal DuplicationAmount = 1m;
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await PowerCmd.Apply<DuplicationPower>(Card.Owner.Creature, DuplicationAmount, Card.Owner.Creature, null);
        }

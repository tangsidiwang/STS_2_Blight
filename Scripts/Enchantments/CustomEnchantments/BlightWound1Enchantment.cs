...
{
    public sealed class BlightWound1Enchantment : EnchantmentModel, IBlightEnchantment
    {
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await PowerCmd.Apply<VulnerablePower>(cardPlay.Target, VulnerableAmount, Card.Owner.Creature, null);
        }

...
{
    public sealed class BlightDazed1Enchantment : EnchantmentModel, IBlightEnchantment
    {
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await CardPileCmd.AddToCombatAndPreview<Dazed>(Card.Owner.Creature, PileType.Discard, DazedCount, addedByPlayer: true);
        }

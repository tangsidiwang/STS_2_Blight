...
{
    public sealed class BlightWeakSelf1Enchantment : EnchantmentModel, IBlightEnchantment
    {
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await PowerCmd.Apply<WeakPower>(Card.Owner.Creature, WeakAmount, Card.Owner.Creature, null);
        }

...
{
    public sealed class BlightPain2Enchantment : EnchantmentModel, IBlightEnchantment
    {
        private const decimal SelfDamageAmount = 2m;
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            await CreatureCmd.Damage(choiceContext, Card.Owner.Creature, SelfDamageAmount, ValueProp.Unblockable | ValueProp.Unpowered | ValueProp.Move, Card);
        }

...
{
    public sealed class BlightVigorous3Enchantment : EnchantmentModel, IBlightEnchantment
    {
        ...
        public bool CanApplyTo(CardModel card)
        {
            ...
            if (BlightEnchantmentRuntimeHelper.HasEnchantment<BlightVigorous3Enchantment>(card))
            {
                return false;
            }

...
{
    public sealed class BlightVigorous9Enchantment : EnchantmentModel, IBlightEnchantment
    {
        public override bool ShowAmount => true;

        public override int DisplayAmount => 9;
        ...
        public bool CanApplyTo(CardModel card)
        {
            ...
            if (BlightEnchantmentRuntimeHelper.HasEnchantment<BlightVigorous9Enchantment>(card))
            {
                return false;
            }
